        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link ${contentPage.equals("register.jsp") ? "active" : ""}" aria-current="page" href="/student/register">
                            <span data-feather="edit-3" class="align-text-bottom"></span>
                            Đăng ký học phần
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${contentPage.equals("result.jsp") ? "active" : ""}" aria-current="page" href="/student/result">
                            <span data-feather="archive" class="align-text-bottom"></span>
                            Kết quả đăng ký học phần
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${contentPage.equals("me.jsp") ? "active" : ""}" href="/student/me">
